...
#, ("A","E"): 1110 , ("B","C"): 1140 , ("B","D"): 1160 , ("C","E"): 1170 , ("C","G"): 1180 , ("D","C"): 350 , ("D","E"): 1190 , ("D","G"): 1200
OD = {
        ...
        if demanda_actual > 0:
            ...
            for i in range(Nparadas-1):
                ...
                for i, incremento in enumerate(incrementos):
                    G.edges[o,d]["flujo"] += incremento*demanda_actual
